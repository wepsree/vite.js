...
export function createMnemonics(
	strength = 256,
	wordlist: Array<string> = bip39.wordlists.EN
): string {
...
export function validateMnemonics(
	mnemonic: string,
	wordlist: Array<string> = bip39.wordlists.EN
): boolean {
...
export function getEntropyFromMnemonics(
	mnemonic: string,
	wordlist: Array<string> = bip39.wordlists.EN
): Hex {
...
export function getSeedFromMnemonics(
	mnemonic: string,
	passphrase = '',
	wordlist: Array<string> = bip39.wordlists.EN
): {
...
export function getMnemonicsFromEntropy(
	entropy: Hex,
	wordlist: Array<string> = bip39.wordlists.EN
): string {
...
export function deriveKeyPairByIndex(
	seed: Hex,
	index: number
