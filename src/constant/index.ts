...
export const ConsensusGroup_ContractAddress =
	'vite_0000000000000000000000000000000000000004d28108e76b';
export const TokenIssuance_ContractAddress =
	...
	UpdateSBPBlockProducingAddress_V2: {
		...
		abi: {
			...
			inputs: [
				{ name: 'gid', type: 'gid' },
				{ name: 'sbpName', type: 'string' },
				{ name: 'newBlockProducingAddress', type: 'address' },
			],
		},
	},
	RevokeSBP_V1: {
	...
	WithdrawSBPReward_V1: {
		...
		abi: {
			...
			inputs: [
				{ name: 'gid', type: 'gid' },
				{ name: 'name', type: 'string' },
				{ name: 'beneficialAddr', type: 'address' },
			],
		},
	},
