...
describe('mnemonic 12 passphrase', function () {
	...
	it('bip39.mnemonicToSeedSync', function () {
		assert.equal(
			seedHex,
			'21a107743295dfec434254374fdbb43ee4701fa699acce6d1810ddae7d356aeeb10bedc09358e5cf8860fc16d225c422f0a44a708267bf0d2bbbbcd3bd299a49'
		);
	});
	it('getSeedFromMnemonics', function () {
...
describe('mnemonic 24 passphrase', function () {
	const mnemonic =
		'hazard kind issue draw bottom foot net join train elbow census present blind assume suit vague vital crack slab material pill census actress panda';
	const passphrase = '123456';
	...
	it('bip39.mnemonicToSeedSync', function () {
		assert.equal(
			seedHex,
			'4e0f10e63407ba168ce6c504631b1d405b121406746b50c7d4831b150985641b867a6edccefaf77554221c44f89bbc0e47038114f50de9f1ffaefbd50c3d6b29'
		);
	});
	it('getSeedFromMnemonics', function () {
		assert.deepEqual(seed, myS.seed);
