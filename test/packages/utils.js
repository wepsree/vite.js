...
describe('utils', function () {
	...
	it('uriStringify', function () {
		...
		assert.equal(
			...
			uriStringify({
				target_address: 'vite_fa1d81d93bcc36f234f7bccf1403924a0834609f4b2e9856ad',
				params: { tti: 'tti_5649544520544f4b454e6e40', amount: 1, data: 'MTIzYWJjZA' },
			})
		);
	});
	...
	it('getTokenIdFromOriginalTokenId', function () {
		assert.equal(
			...
			getTokenIdFromOriginalTokenId('5649544520544f4b454e')
		);
	});
	it('getOriginalTokenIdFromTokenId', function () {
		assert.equal(
			'5649544520544f4b454e',
			getOriginalTokenIdFromTokenId('tti_5649544520544f4b454e6e40')
		);
	});
	...
	it('isHexString', function () {
		...
		assert.equal(
			true,
			isHexString('f0fde0110193147e7961e61eeb22576c535b3442fd6bd9c457775e0cc69f1951')
		);
		assert.equal(
			true,
			isHexString('f0fde0110193147e7961e61eeb22576c535b3442fd6bd9c457775e0cc69f1951', 32)
		);
		assert.equal(
			false,
			isHexString('0f0fde0110193147e7961e61eeb22576c535b3442fd6bd9c457775e0cc69f1951', 32)
		);
	...
	it('isBase64String', function () {
		...
		assert.equal(
			true,
			isBase64String('f0fde0110193147e7961e61eeb22576c535b3442fd6bd9c457775e0cc69f1951')
		);
		assert.equal(
			false,
			isBase64String('f0fde0110193147e71e61eeb22576c535b3442fd6bd9c457775e0cc69f1951')
		);
	...
	const testData = [
		{
			...
			signature:
				'40920d59cc06c723687a990d0da75fac9bbc4cedfc3b1b7abecd3f1bf7f5f250df07829b19f557fe915589ea5f117207531bd827a052a1b1c9df789d01f4980e',
		},
		{
