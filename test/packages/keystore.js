...
const oldKeyJSON = {
	...
	crypto: {
		...
		ciphertext:
			'03d8f2773ddce6132a5ceb136ba736ae1640ba2d664f2a8493a2f3ff2bb84dec8a3229edad6031a7ef494946852d3e3a45b0b3a88eb3167b41a3843d01d93c9abe52479f582b694e9c378dfb5aac7eb5',
...
const keyJSONV1toV2 = {
	encryptentropy:
		'64d689501e27d0ff5b99c06cd1005d0507a37c0d932b9dbccea56f3740fb8736a862735b3cc9c8b68d3e5d8f72091f79',
	crypto: {
		ciphername: 'aes-256-gcm',
		kdf: 'scrypt',
		salt: '5fcccee5c99afd6fc19cda07b0d4bc7e5d4b762cab99d2190ee8cb2b83139ac6',
...
const keyJSONV1toV3 = {
	...
	crypto: {
		ciphername: 'aes-256-gcm',
		ciphertext:
			'c911d743a856e66263df5441fa050ccc667af8ef038966cbb6609fc8b86c5c0ccd745bea459ade7e811bec0391363bdd',
...
if (process.env.NODE_ENV !== 'testWatch') {
	describe('Old_Keystore', function () {
		...
		it('the result of encrypt and decrypt is same', function (done) {
			...
			encryptOldKeystore(privKey, OLD_PWD)
				.then((keystoreF) => {
					decrypt(keystoreF, OLD_PWD)
						.then((_privKey) => {
