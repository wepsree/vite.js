...
import {
	...
	decodeAccountBlockDataByContract,
	getAccountBlockHash,
	signAccountBlock,
...
const accountBlock = {
	...
	signature:
		'FLhv2LCWYHnchw1meqShryTIStI0H9089RL27We+TNMjMro0G+EsOZ8pwCaFpr7mpOKpMp2N4T5WIwavUQ5YDQ==',
...
describe('getCreateContractData', function () {
	it('case 1', function () {
		...
		assert.equal(
			'',
			_data
		);
	});
	it('case 2', function () {
...
it('getCallContractData', function () {
	const data =
		'8pxs4gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGAAAAAAAAAAAAAAAFU0YryhN7rCn0QOmvSrLiwbuCSTAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACc3MAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=';
	const params = [
		'00000000000000000001',
		'ss',
		'vite_553462bca137bac29f440e9af4ab2e2c1bb82493e41d2bc8b2',
	];
...
describe('getAccountBlockHash', function () {
	...
	it('hash 2', function () {
		const accountBlock = {
			...
			signature:
				'xbkjsVzfqoCkUwnU4VktTqs3//XiuLSQtmWcSS+H+FELqwm26ckkxgJBOn68VpdSTEBFmFiJTA2enqiVoKuhDA==',
	...
	it('hash 3', function () {
		const accountBlock = {
			...
			signature:
				'kuspOXODnp6MlJ7hAYb6YBexDCBhbTAaJ0u660OvTuOrviqWtKb3PzE+XV6XroUXhxuDvNB5U+IK8s93n4n7Cg==',
			publicKey: 'iE0KOlLusSBOImOb6BA/tTzocFgtW2q0iHVM1WsFkuA=',
		};
...
describe('signAccountBlock', function () {
	describe('receive', function () {
		const privKey =
			'36509ee50210a386f6ac082b21f72a7021a986a7f3406b4f70745b5260d0b4c0884d0a3a52eeb1204e22639be8103fb53ce870582d5b6ab488754cd56b0592e0';
		const accountBlock = {
			address: 'vite_13f1f8e230f2ffa1e030e664e525033ff995d6c2bb15af4cf9',
			blockType: 4,
			previousHash: '6388daf1e34e9aa9000006f455737ec3d191c7cb7b0d79a882cb976200f55b68',
	...
	describe('send', function () {
		...
		const accountBlock = {
			...
			signature:
				'kVDk2uR5wJOSl6GGNQasAXsnyF/6bBxhYieMceX6mskvIAJ6saboxcIkCeeOgWPAmN5rMtDc2WfJyiD7BXhFAg==',
			publicKey: 'iE0KOlLusSBOImOb6BA/tTzocFgtW2q0iHVM1WsFkuA=',
		};
...
describe('decodeAccountBlockDataByContract error', function () {
	it('type offchain', function () {
		...
		assert.throws(
			() => decodeAccountBlockDataByContract(_data),
			new Error('unsupported abi type offchain')
		);
	});
	it('no method name', function () {
		const _data = {
			data: '',
			abi: [
				'{"anonymous": false, "inputs": [{"indexed": true, "internalType": "tokenId", "name": "tokenId", "type": "tokenId"}], "name": "reIssue", "type": "event"}',
			],
		};
		assert.throws(
			() => decodeAccountBlockDataByContract(_data),
			new Error('method name must be present when abi is an array')
		);
	});
});
...
describe('getTransactionType', function () {
	for (const transactionType in config.blockList) {
		it(transactionType, function () {
			assert.equal(
				getTransactionType(config.blockList[transactionType]).transactionType,
				transactionType
			);
		});
	}
